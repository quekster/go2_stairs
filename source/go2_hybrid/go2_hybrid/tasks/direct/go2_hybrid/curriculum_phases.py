...
PHASES: Dict[int, CurricumlumPhase] = {
    ...
    4: CurricumlumPhase(
        ...
        terrain_path="/home/ril/go2_hybrid/go2_hybrid/source/go2_hybrid/assets/go2_hybrid/updown_18cm_wide.usdz",
        notes="Up+Down stairs 18cm with modification. Continued from previous 18cm curriculum. Added in friction and joint PD randomization.",
        end_point_pos= 18.0,
        base_x_offset= 2.6, 
        base_z_offset= 0.4,
        episode_length_s= 100.0,
    ...
    5: CurricumlumPhase(
        phase_id=5,
        name="stairs_updown_18cm_p5",
        reward_module="rewards_UD_icra_p5",
        terrain_path="/home/ril/go2_hybrid/go2_hybrid/source/go2_hybrid/assets/go2_hybrid/updown_18cm_wide.usdz",
        notes="Same as previous phase but added in external forces randomization.",
        end_point_pos= 18.0,
        base_x_offset= 2.6, 
        base_z_offset= 0.4,
        episode_length_s= 100.0,
